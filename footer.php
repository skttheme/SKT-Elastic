...
<div id="footer-wrapper">
    	...
    	<div class="container footer">
         ...
         <div class="copyright-wrapper">
        	<div class="container">
           		 <div class="copyright-txt"><?php bloginfo('name'); ?> <?php esc_html_e('Theme By ','skt-elastic');?> <a href="<?php echo esc_url('https://www.sktthemes.org/shop/free-flexible-wordpress-theme/');?>" target="_blank">
        <?php esc_html_e('SKT Elastic','skt-elastic'); ?>
        </a></div>
                 <div class="clear"></div>
            </div>           
        </div>
